...
<body>
    ...
    <div>
        <form action="index.php?menuop=eventProx" method="post">
...
echo '<a href="?menuop=eventProx&pagina=1"> primeira pagina </a>';
if($pagina>6){
 ?>
  <a href="?menuop=eventProx$pagina=<?php echo $pagina-1?>"> << </a>;
 <?php
...
for ($i=1;$i<=$totalpagina;$i++){
    if($i>=($pagina-5) && $i <=($pagina+5)){
        if($i==$pagina){
           ...
           echo "<a href=\"?menuop=eventProx&pagina=$i\">$i</a>";
        }
...
echo "<a href=\"?menuop=eventProx&pagina=$totalpagina\">ultima pagina</a>";
